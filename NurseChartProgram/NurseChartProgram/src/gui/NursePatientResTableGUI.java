...
public class NursePatientResTableGUI implements ActionListener, MouseListener {

	NurseGUI ng = null;

	private String[] header = { "환자성명", "주민번호", "예약일자", "진료의사", "의사번호", "결제수단", "결제금액" };
	...
	private JMenuItem[] resrec = new JMenuItem[2];
	private JMenuItem info, waiting, cancellation;
	...
	public JTable getResCancelTable() {
		return resTable;
	}

	public void setResCancelTable(JTable resCancelTable) {
		this.resTable = resCancelTable;
	}
	...
	public NursePatientResTableGUI(NurseGUI n) {
		ng = n;
